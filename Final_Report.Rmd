...
map_boro_agency <- function(dataframe, agencyname, shapefile) {
  ...
  # map!
  ggplot() + geom_polygon(data=shapefile, aes(x=long, y=lat, group=group)) +  
...
<img src="yearly complaints.png" height="400px" width="700px"/>
...
We want to know whether the large number of Pests complaints has some kind of geographical features, so we plot the zipcode of them. It turns out zipcode 10452 make up large percentage of the pests complaints of that day. It may sugggest that lots of people complaint about the same situation at the same day or same group of people make multiple complaints.            
...
<div style="width:200px; height:200px;"text-align:center;">
  <a href='http://tinyurl.com/pigeonViz'><img src ="pigeon_thumb.png" alt="Pigeon Map"/></a>
</div>
